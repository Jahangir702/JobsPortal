...
namespace MVC_Project.Controllers
{
    ...
    public class CandidatesController : Controller
    {
        ...
        {
            return View(db.Candidates.Include(x => x.Qualifications).ToList().ToPagedList(pg, 5));
        }
        public ActionResult Create()
        {
            ViewBag.PostList = new List<SelectListItem>
            {
                ...
                new SelectListItem{Text="Office Assistant", Value="Office Assistant"}
            };
            return View();
        }
        ...
        public ActionResult EditImage(int id, ImageUpload pic)
        {
            if (ModelState.IsValid)
            {
                if (pic.Picture != null)
